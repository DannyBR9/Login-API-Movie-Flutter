import 'package:appfinal/model/cast_response.dart';
import 'package:appfinal/model/genre_response.dart';
import 'package:appfinal/model/movie_detail_response.dart';
import 'package:appfinal/model/movie_response.dart';
import 'package:dio/dio.dart';
import 'package:appfinal/model/person_response.dart';
import 'package:appfinal/model/video_response.dart';
...
class MovieRepository {
  ...
  Future<MovieResponse> getMovieByGenre(int id) async {
    var params = {"api_key": apiKey, "language": "es-ES", "page": 1, "with_genres": id};
    try {
