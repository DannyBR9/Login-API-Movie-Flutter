...
import 'package:appfinal/bloc/get_persons_bloc.dart';

import 'package:appfinal/model/person.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("PERSONAS DE TENDENCIA EN ESTA SEMANA", style: TextStyle(
